 ...
 *  Description:  Calculator Servlet<p>
 *
 *  @version 1.0 April 2002<p>
 *  @author Minesh Patel<p>
 *
 *  This servlet class handles the Calculator section.
 */
...
public class CalculatorServlet extends HttpServlet {
  ...
  {		// Forward page
	    RequestDispatcher rd = request.getRequestDispatcher("/Organiser_main/Calculator/Calculator.jsp");
