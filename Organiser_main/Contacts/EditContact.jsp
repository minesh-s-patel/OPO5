...
<body bgcolor="#BFC8DF" text="#000000" Onload="change()">
  ...
  <table border="3" width="600" height="500" cellpadding="6" cellspacing="3">
      ...
      <td height="100%">
		<form name="EditContact" method="post" action="UpdateContact">
        <p><font face='Courier New' size='3'><b><center>Please edit the Contact's information</center><b></font></p>
		<% 
		...
		%>
		  ...
		  <tr> 
              ...
              <td>
				<select name=month onChange="document.EditContact.group.value=this.value">
				<%
				...
				groupnames.add(0,"click to change");
				...
				value='<jsp:getProperty name="contactBean" property="groupName" />'>
...
<%
				...
				if (bday.equals("0000-00-00"))
					out.println("<input type='text' name='birthday' size=25>");
				else {
					bday = opo.util.StringFormat.toDateString(bday, "yyyy-MM-dd", "dd/MM/yyyy");
					out.println("<input type='text' name='birthday' size=25 value='" + bday + "'>");
				}
...
%>
				...
				<input type="hidden" name="oldNickname"
				value='<jsp:getProperty name="contactBean" property="nickName" />'>
